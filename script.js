let githubUser = 'Hasame14011'
let repo = 'Hasame.github.io'
...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbwC07LsEgyx4pmZJsr1MSfcetBJVEI6Ridz-0Q1xyIangWtj-m-S3BHSEziEnIlOF641A/exec');
